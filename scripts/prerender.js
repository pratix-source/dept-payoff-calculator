...
const source = fs.readFileSync(path.join(root, 'tools/debt-payoff-calculator.html'), 'utf8');
const dist = path.join(root, 'dist');
const origin = 'https://pratix.io';
const metadata = { title: 'Debt Payoff Calculator | Pratix.io', description: 'Plan debt payoff strategies, compare repayment methods and estimate your path to becoming debt free in your browser.', route: '/en/tools/debt-payoff-calculator.html' };
